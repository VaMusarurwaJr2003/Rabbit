...
const MatingForm = () => {
  ...
  const checkoutSchema = yup.object().shape({
    ...
    Try1: yup.string().required("required"),
    Try2: yup.string().required("required"),
  ...
  const handleSubmit = (values) => {
    ...
    axios
      .post('http://localhost:3002/matingform', {
        Date: date,
        Father: father,
        Mother: mother,
        Shade: shade,
            ...
            <Form >
              ...
              >
                ...
                <TextField
                  ...
                  type='date'
                  variant='filled'
                  onChange={(event) => { settry1(event.target.value) }}
                  onBlur={handleBlur}
                  onInput={handleChange}
                  label="Mating Date Try1"
                  name='Try1'
                  error={!!touched.Try1 && !!errors.Try1}
                  helperText={touched.Try1 && errors.Try1}
                  sx={{ gridColumn: "span 2" }}
                />
                ...
                <TextField
                  ...
                  type='date'
                  variant='filled'
                  onChange={(event) => { settry2(event.target.value) }}
                  onBlur={handleBlur}
                  onInput={handleChange}
                  label="Expected Mating Date Try2"
                  name='Try2'
                  error={!!touched.Try2 && !!errors.Try2}
                  helperText={touched.Try2 && errors.Try2}
                  sx={{ gridColumn: "span 2" }}
                />
